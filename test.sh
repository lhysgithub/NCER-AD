# SMD
python main.py --anormly_ratio 0.5 --num_epochs 5 --batch_size 8 --mode train --dataset SMD --data_path ../Anomaly-Transformer-main/dataset/SMD/ --input_c 38 --output_c 38 --n_memory 10 --lambd 0.01 --lr 1e-4 --memory_initial False --phase_type None 

python main.py --anormly_ratio 0.5 --num_epochs 5  --batch_size 8  --mode memory_initial --dataset SMD  --data_path ../Anomaly-Transformer-main/dataset/SMD/  --input_c 38 --output_c 38 --n_memory 10 --lambd 0.01 --lr 5e-5 --memory_initial True --phase_type second_train

# test
python main.py --anormly_ratio 0.5 --num_epochs 5   --batch_size 256  --mode test --dataset SMD  --data_path ../Anomaly-Transformer-main/dataset/SMD/ --input_c 38 --output_c 38 --n_memory 10 --memory_initial False --phase_type test
